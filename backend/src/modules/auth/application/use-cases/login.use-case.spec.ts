...
describe('LoginUseCase', () => {
    ...
    describe('execute', () => {
        ...
        it('should return access and refresh tokens on successful login', async () => {
            const user = new User('1', dto.email, 'Test User', 'hashed_password');
            ...
            expect(tokenService.hashRefreshToken).toHaveBeenCalledWith('refresh_token');
        ...
        it('should throw UnauthorizedException if password is not valid', async () => {
            ...
            expect(passwordService.compare).toHaveBeenCalledWith(dto.password, 'wrong_hash');
